...
Data abort info:
  ...
  CM = 0, WnR = 1
user pgtable: 4k pages, 39-bit VAs, pgdp=000000004203c000
[0000000000000000] pgd=000000004202a003, p4d=000000004202a003, pud=000000004202a003, pmd=0000000000000000
...
sp : ffffffc010c53db0
x29: ffffffc010c53db0 x28: ffffff8001ff5780 
x27: 0000000000000000 x26: 0000000000000000 
x25: 0000000000000000 x24: 0000000000000000 
x23: 0000000000000000 x22: ffffffc010c53e30 
x21: 00000000004c9940 x20: ffffff800200ef00 
...
x5 : ffffff8002239ce8 x4 : ffffffc008677000 
...
---[ end trace 2cb5b33c845f71c8 ]---
```

#Analysis of oops message:

**Error:** As per the details in line 1, Unable to handle kernel NULL pointer dereference at virtual address 0000000000000000
It means that the pointer is trying to access inaccessible address.
pc : faulty_write+0x10/0x20 [faulty] : It means that the fault occurred at faulty_write(). This error occurred at 0x10 address. Since, the pointer is NULL, oops got triggered.

##objdump generated of faulty.ko file

```bash
buildroot/output/build/ldd-b7254579bf697912f668092205024f1159409d6c/misc-modules/faulty.ko:     file format elf64-littleaarch64
